...
import { X, CreditCard, Lock, ShieldCheck, CheckCircle2, AlertCircle, RefreshCw, ExternalLink, FileText, ArrowRight } from 'lucide-react';
...
export default function PaymentCheckoutModal({ isOpen, onClose, application }: PaymentCheckoutModalProps) {
  ...
  const [provider, setProvider] = useState<'Mercado Pago' | 'Stripe' | 'Transferencia CBU'>('Mercado Pago');
            ...
            {!completedPayment ? (
              <>
                ...
                {isProcessing || isWebhookValidating ? (
                  ...
                  >
                    <span>Proceder al Checkout Seguro ({provider})</span>
